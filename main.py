...
parser.add_argument('--dy_embedding_dim',type=int,default=16, help='the dimension of evolving node representation')
parser.add_argument('--dy_interval',type=list, default=[31,21,14,5,1],help='time intervals for each layer')
...
def objective(trail):
    ...
    model = EMGNN(args.dy_embedding_dim, args.dy_interval, args.num_nodes, args.seq_in_len, args.seq_out_len, args.in_dim, args.out_dim, 1, args.layers,
                  conv_channels=args.conv_channels, residual_channels=args.residual_channels,
                  skip_channels=args.skip_channels, end_channels= args.end_channels, kernel_set=args.kernel_set,
                  dilation_exp=args.dilation_exponential, gcn_depth=gcn_depth,
...
def main(runid):
    ...
    Data = DataLoaderS(args.data, 0.7, 0.15, device, args.horizon, args.seq_in_len, args.normalize) 
    ...
    model = EMGNN(args.dy_embedding_dim, args.dy_interval, args.num_nodes, args.seq_in_len, args.seq_out_len, args.in_dim, args.out_dim, 1, args.layers,#标记过红点
                  conv_channels=args.conv_channels, residual_channels=args.residual_channels,
                  skip_channels=args.skip_channels, end_channels= args.end_channels, kernel_set=args.kernel_set,
                  dilation_exp=args.dilation_exponential, gcn_depth=best_params['gcn_depth'],
                  device=device, fc_dim = (node_fea.shape[0]-18)*16, st_embedding_dim=args.st_embedding_dim,                  
